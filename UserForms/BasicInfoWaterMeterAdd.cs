...
{
    public partial class BasicInfoWaterMeterAdd : DevExpress.XtraEditors.XtraUserControl
    {
        
        public BasicInfoWaterMeterAdd()
        {
            InitializeComponent();
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        BusinessLogicBridge.DataStore.addDataWaterMeter(lookUpEditBuilding.EditValue.ToString(), lookUpEditFloor.EditValue.ToString(), gridLookUpEditRoom.EditValue.ToString(), txtmeter_label.Text, txtmeter_serial.Text, txtmeter_model.Text, memometer_detail.Text);
                        BasicInfoWater.AddPanel_ControlRemoved();
                        BasicInfoWater.AddPanel.Close();
                    }
                }

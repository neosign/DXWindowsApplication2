...
{
    public partial class ReportWaterConsummation : uBase
    {
        public ReportWaterConsummation()
        {
            InitializeComponent();
        ...
        protected void ExportExcelManual(DataTable RoomTable)
        {
            ...
            ReportDocuments.waterAccumulate PrintElectric = new DXWindowsApplication2.ReportDocuments.waterAccumulate();
            ...
            string pathname = DXWindowsApplication2.MainForm.CombinePaths(Environment.GetFolderPath(Environment.SpecialFolder.Personal), GeneralInfo.Rows[0]["path_all_document"].ToString(), "Report", "Water_" + DateTime.Now.ToString("yyyyMMdd") + ".pdf");
        ...
        protected void ExportExcelHourManual(DataTable RoomTable)
        {
            ...
            ReportDocuments.waterHourUnit PrintElectric = new DXWindowsApplication2.ReportDocuments.waterHourUnit();

            pathname = DXWindowsApplication2.MainForm.CombinePaths(Environment.GetFolderPath(Environment.SpecialFolder.Personal), GeneralInfo.Rows[0]["path_all_document"].ToString(), "Report", "WaterUnitHour_" + DateTime.Now.ToString("yyyyMMdd") + ".xls");
        ...
        protected void ExportExcelUnitHourManual(DataTable RoomTable)
        {
            ...
            ReportDocuments.waterHourSX PrintElectric = new DXWindowsApplication2.ReportDocuments.waterHourSX();

            pathname = DXWindowsApplication2.MainForm.CombinePaths(Environment.GetFolderPath(Environment.SpecialFolder.Personal), GeneralInfo.Rows[0]["path_all_document"].ToString(), "Report", "WaterHour_" + DateTime.Now.ToString("yyyyMMdd") + ".xls");
        ...
        protected void ExportExcelDailyManual(DataTable RoomTable)
        {
            ...
            ReportDocuments.waterDay PrintElectric = new DXWindowsApplication2.ReportDocuments.waterDay();
            ...
            string pathname = DXWindowsApplication2.MainForm.CombinePaths(Environment.GetFolderPath(Environment.SpecialFolder.Personal), GeneralInfo.Rows[0]["path_all_document"].ToString(), "Report", "WaterDaily_" + DateTime.Now.ToString("yyyyMMdd") + ".xls");
        ...
        protected void ExportExcelMonthlyManual(DataTable RoomTable)
        {
            ...
            ReportDocuments.waterMonth PrintElectric = new DXWindowsApplication2.ReportDocuments.waterMonth();
            ...
            string pathname = DXWindowsApplication2.MainForm.CombinePaths(Environment.GetFolderPath(Environment.SpecialFolder.Personal), GeneralInfo.Rows[0]["path_all_document"].ToString(), "Report", "WaterMonthly_" + DateTime.Now.ToString("yyyyMMdd") + ".xls");
        ...
        private void bttExport_Click(object sender, EventArgs e)
        {
            ...
            if (radioGroupMeterType.SelectedIndex == 0)
            {
                ...
                DataTable EMaxFromDT = BusinessLogicBridge.DataStore.getReportWMax(lookUpEditRoomFrom.EditValue.To<int>(), lookUpEditRoomTo.EditValue.To<int>(), dateEditFromDate.EditValue.ToString());
                // where buildingID , roomIDFrom , roomIDTo, DatetimeTo
                DataTable EMaxToDT = BusinessLogicBridge.DataStore.getReportWMax(lookUpEditRoomFrom.EditValue.To<int>(), lookUpEditRoomTo.EditValue.To<int>(), dateEditTodate.EditValue.ToString());
                ...
                for (int i = 0; i < EMaxToDT.Rows.Count; i++)
                {
                    ...
                    totalUnit = utilClass.CalculateUnitEWMeter(EMaxToDT.Rows[i]["TotalUnit"].To<double>(),EMaxFromDT.Rows[i]["TotalUnit"].To<double>());
                    if (totalUnit < 0)
                        totalUnit = 0.0;
